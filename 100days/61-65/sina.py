...
def get_matched_parts(conten_string, pattern):
    """从字符串中提取所有跟正则表达式匹配的内容"""
    return pattern.findall(conten_string, re.I) \
        if conten_string else []
    ...
    while new_urls:
        ...
        if depth != max_depth:
            ...
            for content in contents:
                ...
                if href:
                    href = repair_incorrect_href(current_url,href) #这里有问题
                print(text, href)
